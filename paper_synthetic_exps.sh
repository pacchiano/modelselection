...
papervariants_shared=DoublingDataDriven-s,EstimatingDataDriven-s,Corral-s,BalancingClassic-s,UCB-s,Greedy-s,EXP3-s
...
do
	python experiments_synthetic.py 1000 $experiment $num_experiments $allmodselalgos,$allmodselalgos_shared True;
	python experiments_synthetic.py 1000 $experiment $num_experiments $corralvariants,$corralvariants_shared True;	
	python experiments_synthetic.py 1000 $experiment $num_experiments $exp3variants,$exp3variants_shared True;
	python experiments_synthetic.py 1000 $experiment $num_experiments $doublingvariants,$doublingvariants_shared True;
	python experiments_synthetic.py 1000 $experiment $num_experiments $estimatedvariants,$estimatedvariants_shared True;
	python experiments_synthetic.py 1000 $experiment $num_experiments $papervariants,$papervariants_shared True;
